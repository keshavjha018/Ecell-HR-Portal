...
class Email {
    ...
    sendVerificationMail = async(Token, userId, userEmail, userName, callback) => {
        ...
        // Token is generated by JWT on the server side
        // token is the randomly generated token via utils function
        try{
            const verificationLink = apiHostUrl + `verify/mail?userId=${userId}&token=${Token}`;
    ...
    complaintRegistered = async (id, regno) => {
